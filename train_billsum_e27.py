#!/usr/bin/env python3
"""
Train BillSum E27 (GPT-2 Adapters)
...
print("="*80)
print("TRAINING: BillSum E27 (GPT-2 Adapters)")
print("="*80)
...
checkpoints_dir = BASE_PATH / "GPT2" / "checkpoints" / "E27_Adapters"
results_dir.mkdir(parents=True, exist_ok=True)
checkpoints_dir.mkdir(parents=True, exist_ok=True)

print("\n1. Starting energy tracking...")
tracker = EmissionsTracker(
    project_name="E27_BillSum_GPT2_Adapters",
...
try:
    ...
    print("\n6. Applying Adapters configuration...")
    ...
    results = {
        "experiment_id": "E27",
        "experiment_name": "E27_GPT2_Adapters",
        "model": model_name,
        "model_type": "gpt2",
        "method": "Adapters",
        "dataset": "billsum",
        ...
        "gradient_accumulation_steps": 16,
        "learning_rate": 2e-4,
        "note": "Legislative bill summarization - GPT-2 Adapters"
    }
    
    result_file = results_dir / "E27_results.json"
    ...
    result_file = results_dir / "E27_results_FAILED.json"
    with open(result_file, 'w') as f:
        json.dump(results, f, indent=2)
