...
print("="*80)
print("TRAINING: XSum E26 (GPT-2 QLoRA)")
print("="*80)
...
try:
    print("\n2. Loading XSum dataset...")
    from datasets import load_dataset
    dataset = load_dataset("xsum")
    
    # Calculate samples for 500 training samples
    ...
    training_args = TrainingArguments(
        ...
        save_steps=500,
        save_strategy="steps",
        fp16=False,  # QLoRA uses its own precision
        max_grad_norm=0.3,
        save_total_limit=2,
        report_to="none",
    ...
    results = {
        ...
        "gradient_accumulation_steps": 16,
        "learning_rate": 3e-4,
        "note": "Short news summarization - GPT-2 QLoRA"
    }
