...
print("="*80)
print("TRAINING: BillSum E14 (T5 QLoRA)")
print("="*80)
...
try:
    ...
    print("\n3. Loading T5 model with 4-bit quantization...")
    model_name = "t5-base"
    ...
    results = {
        ...
        "gradient_accumulation_steps": 16,
        "learning_rate": 3e-4,
        "note": "Legislative bill summarization - T5 QLoRA"
    }
    
    result_file = results_dir / "E14_results.json"
    ...
    result_file = results_dir / "E14_results_FAILED.json"
    with open(result_file, 'w') as f:
        json.dump(results, f, indent=2)
