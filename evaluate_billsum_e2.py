#!/usr/bin/env python3
"""
Evaluate BillSum E2 - BART QLoRA
Generates ROUGE-1, ROUGE-2, ROUGE-L scores
Run this AFTER train_billsum_e2_fixed.py completes successfully
"""
...
print("=" * 70)
print("EVALUATION: BillSum E2 - BART QLoRA")
print("=" * 70)

CHECKPOINT_DIR = Path("E:/Pending Experiment data/BillSum_Experiments/BART/checkpoints/E2_QLoRA")
RESULTS_DIR    = Path("E:/Pending Experiment data/BillSum_Experiments/BART/results")
...
out_file = RESULTS_DIR / "E2_QLoRA_evaluation.json"
...
print("=" * 70)
print("\nUpdate Experiment_Results.csv with these scores for BILLSUM_E2")
